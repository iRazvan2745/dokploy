...
export const BreadcrumbSidebar = ({ list }: Props) => {
	...
	return (
		<header className="flex h-16 shrink-0 -mx-4 border-b w-[calc(100svw-19.5rem)] items-center gap- 2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
