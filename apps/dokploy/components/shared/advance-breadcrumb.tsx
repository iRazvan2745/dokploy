...
export const AdvanceBreadcrumb = () => {
	...
	return (
		<header className="sticky top-0 bg-background/80 backdrop-blur-lg z-50 flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 border-b -mx-4 mb-7">
